...
from colores import BOLD, ROJO, VERDE, NARANJA, AMARILLO, CYAN, RESET
from fruteria import FRUTAS, mostrar_cesta, procesar_comando_global, buscar_fruta, mostrar_mensaje, solicitar_kilos, actualizar_cesta, mostrar_ticket, procesar_pago, crear_pdf
from utils import SUBIR, BORRAR, BANDERAS, limpiar_pantalla
